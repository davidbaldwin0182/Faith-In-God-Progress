//
//  talentsDetailViewController.swift
...
class talentsDetailViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let indexed = selectedName?.index {
            let myArticle = "myDocT\(indexed)\(names)"
    ...
    @IBAction func saveFileBtn(_ sender: Any) {
        ...
        let names = newUserUid
        if let indexed = selectedName?.index {
            let myDoc = "myDocumentTalNote\(indexed)\(names).txt"
    ...
    @objc func checkBtn(sender: UIBarButtonItem) {
        ...
        let names = newUserUid
        if let indexed = selectedName?.index {
            let myArticle = "myDocT\(indexed)\(names).txt"
    ...
    func show() {
        ...
        let names = newUserUid
        if let indexed = selectedName?.index {
            let myDoc = "myDocumentTalNote\(indexed)\(names)"
