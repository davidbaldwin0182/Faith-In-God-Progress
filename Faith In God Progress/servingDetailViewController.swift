//
//  servingDetailViewController.swift
...
class servingDetailViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let indexed = selectedName?.index {
            let myArticle = "myDocS\(indexed)\(names)"
    ...
    @IBAction func saveFileBtn(_ sender: Any) {
        ...
        let names = newUserUid
        if let indexed = selectedName?.index {
            let myDoc = "myDocumentSerNote\(indexed)\(names).txt"
    ...
    @objc func checkBtn(sender: UIBarButtonItem) {
        ...
        let names = newUserUid
        if let indexed = selectedName?.index {
            let myArticle = "myDocS\(indexed)\(names).txt"
    ...
    func show() {
        ...
        let names = newUserUid
        if let indexed = selectedName?.index {
            let myDoc = "myDocumentSerNote\(indexed)\(names)"
