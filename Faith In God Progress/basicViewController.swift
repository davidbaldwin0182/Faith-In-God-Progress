...
class basicViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    let basics = [DataItemA(item: "1", name: "Prayer", message: "Daily prayer to Heavenly Father.", checkMarked: "checkMark", checkValue: "false", index: 1, study: ""), DataItemA(item: "2", name: "Studying scriptures", message: "Studying the scriptures regularly.", checkMarked: "checkMark", checkValue: "false", index: 2, study: ""), DataItemA(item: "3", name: "Keeping the commandments", message: "Keeping the commandments.\n Living My Gospel Standards.", checkMarked: "checkMark", checkValue: "false", index: 3, study: ""), DataItemA(item: "4", name: "Honoring your parents", message: "Honoring your parents.\n Being kind to your family.", checkMarked: "checkMark", checkValue: "false", index: 4, study: ""), DataItemA(item: "5", name: "Paying tithing", message: "Paying your tithing.\n Attending tithing settlement.", checkMarked: "checkMark", checkValue: "false", index: 5, study: ""), DataItemA(item: "6", name: "Attending meetings ", message: "Attending sacrament and Primary regularly.", checkMarked: "checkMark", checkValue: "false", index: 6, study: "")]
